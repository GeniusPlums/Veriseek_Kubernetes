...
#---------------------------------------------------------
S3_BUCKET="VeriseekEducation-global-prod-storage"
MONGODB_HOST="mongodb.veriseekeducation.com:27017"
...
mongo
use VeriseekEducation_prod_edx;
db.dropDatabase();
exit

mongorestore -d VeriseekEducation_prod_edx ~/backups/mongodb/mongo-dump-${BACKUP_KEY}/edxapp --host $MONGODB_HOST
