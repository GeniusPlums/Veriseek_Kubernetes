...
S3_BUCKET="VeriseekEducation-global-prod-backup"
...
# MONGODB_HOST: mongodb.service.veriseekeducation.com
# MONGODB_PORT: "27017"
#
#------------------------------------------------------------------------------
$(ksecret.sh mongodb-admin VeriseekEducation-global-service)
